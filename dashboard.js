async function fetchCurrentData() {
  try {
    ...
    // Assuming CSV order: Timestamp, WindSpeed, WindDirection, Humidity, Pressure, Temperature(C)
    ...
    // Format Last Updated with AM/PM
    const now = new Date();
...
setInterval(updateLiveTime, 1000);      // every 1 second
